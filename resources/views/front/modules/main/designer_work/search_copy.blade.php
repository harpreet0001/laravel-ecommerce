                ...
                <div class="right-content">
                    ...
                    <div class="search-form-wrapper">
                        <div class="search-form">
                            <div class="inputs">
                                <input type="text" name="search" value="y" placeholder="Keywords" id="input-search" class="form-control">
                                <select name="category_id" class="form-control">
                                    <option value="0">All Categories</option>
                                    <option value="59" selected="selected">Melanotan 2</option>
                                    <option value="60">MT2 Starter Kits</option>
                                    <option value="61">Melanotan Nasal Spray</option>
                                    <option value="63">MT2 Reseller Packs</option>
                                    <option value="62">Tanning Injections Supplies</option>
                                </select>
                            </div>
                            <div class="checkbox">
