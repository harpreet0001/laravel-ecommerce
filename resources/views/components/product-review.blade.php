 <div id="review">
    @if(isset($product_reviews))
        ...
        <table class="table table-striped table-bordered">
            <tbody>
                <tr>
                    <td style="width: 50%;"><strong>{{ucwords($product_review->posted_by)}}</strong></td>
                    <td class="text-right">{{fnDateFormat($product_review->created_at)}}</td>
                </tr>
                <tr>
                    <td colspan="2">
                                ...
                                <div class="all-star-rating">
                                    <span class="inner-star_spans">
                                        <div class="star-ratings">
                                            <div class="fill-ratings" style="width:{{fnPercentage($product_review->rating,5)}}%">
                                              <span>🟊🟊🟊🟊🟊</span>
                                            </div>
...
<form class="form-horizontal" id="form-review" action="{{route('product.addProductReview',base64_encode($product->_id))}}" onsubmit="productreview.add(this)">  
    <div class="review-form-inner">
        <h4>Write a review</h4>
        <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-name">Your Name</label>
            <div class="col-sm-10">
                <input type="text" name="posted_by" value="@if(auth()->check()){{auth()->user()->firstname}} {{auth()->user()->lastname}}@endif" id="input-posted_by" class="form-control">
