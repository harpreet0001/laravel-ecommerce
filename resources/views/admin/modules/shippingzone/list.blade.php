            ...
            <div class="tab-content p-0">
               ...
               <div class="table-responsive">
                  <table class="table table-bordered cstm-data-table">
                     ...
                     <tbody>
                        @if($ShippingzoneList->count() > 0)
                           @foreach($ShippingzoneList as $key=>$value)
                              <tr>
                                 <td>{{$key+1}}</td>
                                 ...
                                 <td>
                                    <ul class="action_btns_wrap a-i-c">
                                       ...
                                       <label class="switch mini-switch">
                                          <input type="checkbox" class="target_switch" data-attr="{{route('shippingzone-enabled',$value->_id)}}" {{$value->zoneenabled==1 ? 'checked' : ''}}>
