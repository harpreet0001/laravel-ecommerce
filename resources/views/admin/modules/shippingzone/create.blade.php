      ...
      <div class="card">
         ...
         <div class="card-body">
            <div class="tab-content p-0">
               @include('msg')
               <form class="cstm-form" method="post" action="{{route('shippingzone-save')}}" name="blog-create" enctype="multipart/form-data">
                  @csrf
                  @method('post')
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control @error('zonename') is-invalid @enderror" placeholder="shipping zone name" name="zonename" value="{{ old('zonename') }}"  autocomplete="zonename" autofocus>
                           @error('zonename')
                     ...
                     <div class="col-lg-12" id="ZoneTypeCountry">
                       <div class="form-check">
                         <input type="checkbox" name=" zoneenabled" id="zoneenabled" value="1" class="form-check-input @error('zoneenabled') is-invalid @enderror" >
