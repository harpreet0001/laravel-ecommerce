      ...
      <div class="card">
         ...
         <div class="card-body">
            <div class="tab-content p-0">
               @include('msg')
               <form class="cstm-form" method="post" action="{{route('category-save')}}" name="category-save" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                     <div class="col-lg-5">
                     ...
                     <div class="col-lg-5">
                        <div class="form-group">
                           ...
                           <select name="top" class="form-control @error('description') is-invalid @enderror">
                              <option value="0" @if(old('top') && old('top') == '0'){{'selected'}}@endif>No</option>
                              <option value="1" @if(old('top') && old('top') == '1'){{'selected'}}@endif>Yes</option>
                           </select>
                           @error('description')
                              <span class="invalid-feedback" role="alert">
                                 <strong>{{ $message }}</strong>
                     ...
                     <div class="col-lg-7">
                        <div class="form-group">
                           ...
                           <textarea class="form-control @error('description') is-invalid @enderror" placeholder="Description" id="category-ckeditor" name="description">{{ old('description') }}</textarea>
                           @error('description')
                              <span class="invalid-feedback" role="alert">
                                 <strong>{{ $message }}</strong>
                              </span>
