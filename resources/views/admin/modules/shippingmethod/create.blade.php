   ...
   <div class="content-card">
      <div class="card">
        <div class="card-header d-f j-c-s-b" style="cursor: move;">
            <h3 class="card-title">Create shipping method for {{$shippingzone->zonename}}</h3>
            <div class="btn-wrap">
         ...
         <div class="card-body">
            <div class="tab-content p-0">
               @include('msg')
                <form class="cstm-form" method="post" action="{{route('shippingmethod-save',$shippingzone->_id)}}"  onsubmit="return SubmitShippingMethod.create(this)">
                  @csrf
                  @method('post')
                      ...
                      <div class="row">
                          ...
                          <div class="form-group">
                             ...
                             <select name="methodmodule" id="methodmodule" class="form-control" onchange="UpdateModule(this);" data-url="{{route('shipping-module-properties')}}">
                              <option selected disabled>select</option>
                                <optgroup label="Fixed Shipping Quotes">
                                  <option value="shipping_peritem">Flat Rate Per Item</option>
                                  <option value="shipping_byweight">Ship by Weight</option>
                                  <option value="shipping_bytotal">Ship by Order Total</option>
                                  <option value="shipping_flatrate">Flat Rate Per Order</option>
                                </optgroup>
                             </select>
                        ...
                        <div class="col-lg-12">
                          <div class="form-group">
                             ...
                             <input type="text" name="methodname" id="methodname" value="" class="form-control" placeholder="shipping zone name">
                        ...
                        <div class="col-lg-12">
                          <div class="form-check">
                            <input type="checkbox" name="methodenabled" id="methodenabled" value="1" class="form-check-input" >
                        ...
                        <div class="col-lg-12">
                          <!--shipping-settings-->
                            ...
                            <div class="shipping-method" id="shippingMethodSettings"></div>
