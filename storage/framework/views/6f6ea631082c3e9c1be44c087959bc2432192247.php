	...
	<?php if(isset($products) && count($products->toArray()) > 0): ?>
	 <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <figcaption>
            ...
            <!-- <div class="stats">
                <span class="stat-1"><span class="stats-label">Brand:</span> <span><a href="https://dev.megatan.ws/MEGATAN"><?php echo e($product->getProductBrand->title ?? ''); ?></a></span></span>
                <span class="stat-2"><span class="stats-label">Model:</span> <span><?php echo e($product->model ?? ''); ?></span></span>
            </div> -->
...
</div><?php /**PATH /home/megatanws/public_html/web/resources/views/components/feature-product.blade.php ENDPATH**/ ?>