...
<head>
    <title><?php echo e($pageTitle ?? env('APP_NAME')); ?></title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <?php echo $__env->yieldContent('meta-data'); ?>
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>" />
    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo e(asset('front/images/fav-icon/apple-icon-57x57.png')); ?>">
    <link rel="apple-touch-icon" sizes="60x60" href="<?php echo e(asset('front/images/fav-icon/apple-icon-60x60.png')); ?>">
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo e(asset('front/images/fav-icon/apple-icon-72x72.png')); ?>">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo e(asset('front/images/fav-icon/apple-icon-76x76.png')); ?>">
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo e(asset('front/images/fav-icon/apple-icon-114x114.png')); ?>">
    <link rel="apple-touch-icon" sizes="120x120" href="<?php echo e(asset('front/images/fav-icon/apple-icon-120x120.png')); ?>">
    <link rel="apple-touch-icon" sizes="144x144" href="<?php echo e(asset('front/images/fav-icon/apple-icon-144x144.png')); ?>">
    <link rel="apple-touch-icon" sizes="152x152" href="<?php echo e(asset('front/images/fav-icon/apple-icon-152x152.png')); ?>">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('front/images/fav-icon/apple-icon-180x180.png')); ?>">
    <link rel="icon" type="image/png" sizes="192x192" href="<?php echo e(asset('front/images/fav-icon/android-icon-192x192.png')); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('front/images/fav-icon/favicon-32x32.png')); ?>">
    <link rel="icon" type="image/png" sizes="96x96" href="<?php echo e(asset('front/images/fav-icon/favicon-96x96.png')); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('front/images/fav-icon/favicon-16x16.png')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('front/css/owl.carousel.min.css')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('front/css/cstm-style.css')); ?>">
    ...
    <script id="ze-snippet" src="https://static.zdassets.com/ekr/snippet.js?key=<?php echo e(env('ZE_SNIPPET_KEY')); ?>"> </script>
...
<body>
    ...
    let globalUrls = {
        ...
        compare: {
            ...
            add: "<?php echo e(route('compare.add')); ?>"
        },

        wishlist: {

            add: "<?php echo e(route('wishlist.add')); ?>"
        }
    };
    </script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('front/js/validation.js')); ?>"></script>
    ...
    <?php echo $__env->yieldContent('custom_routes'); ?>
    <?php echo $__env->yieldContent('js'); ?>
    <script type="text/javascript" src="<?php echo e(asset('front/js/custom-js.js')); ?>"></script>
    <script type="text/javascript">
...
</html><?php /**PATH /home/megatanws/public_html/web/resources/views/front/layouts/layout.blade.php ENDPATH**/ ?>