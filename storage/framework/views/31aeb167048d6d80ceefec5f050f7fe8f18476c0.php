...
<div class="content-wrapper p-4">
  <div class="content-card">
    ...
    <form onsubmit="Order_Form.placeOrder(this)" method="post" action="<?php echo e(route('placeOrder')); ?>" id="order_placed_form" >
        <?php echo csrf_field(); ?>
            ...
            <div class="radio-content-area">
              <div class="search-field orderForToggle orderForToggleExisting" style="display: none;">
                <div class="form-group">
                  ...
                  <input type="text" name="searchCustomer" data-search-customer-url="<?php echo e(route('search-customer')); ?>" placeholder="type a customer name,email" class="form-control" autocomplete="nope">
...
<?php $component = $__env->getContainer()->make(App\View\Components\Country::class, ['fieldname' => 'billingCountryId','classes' => 'country form-control']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\State::class, ['fieldname' => 'billingStateId','classes' => 'state form-control']); ?>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                      <div class="form-group required">
                          ...
                          <div class="">
                               <?php if (isset($component)) { $__componentOriginalc09f45ae8d7885be35947834572c6aa413dc522b = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Country::class, ['fieldname' => 'shippingCountryId','classes' => 'country form-control']); ?>
<?php $component->withName('country'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?> 
                  ...
                  <div class="col-lg-6">
                     <div class="form-group required">
                          ...
                          <div class="">
                               <?php if (isset($component)) { $__componentOriginalb2640b77c32d26ba10655579995102bd879c2ae6 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\State::class, ['fieldname' => 'shippingStateId','classes' => 'state form-control']); ?>
<?php $component->withName('state'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<script type="text/javascript">
  ...
  let customRoutes = {
                          'check-email-availability' : "<?php echo e(route('check-email-availability')); ?>" ,
                          'get-address-list'         : "<?php echo e(route('get-address-list')); ?>",
                          'search-products'          : "<?php echo e(route('search-products')); ?>" ,
                          'add-product'              : "<?php echo e(route('add-product')); ?>",
                          'delete-product'           : "<?php echo e(route('delete-product')); ?>",
                          'get-shipping-methods'     : "<?php echo e(route('get-shipping-methods')); ?>",
                          'save-order-detail'        : "<?php echo e(route('save-order-detail')); ?>"
                    };
</script>
<script type="text/javascript" src="<?php echo e(asset('sadmin/js/order_create.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megatanws/public_html/web/resources/views/admin/modules/order/create.blade.php ENDPATH**/ ?>