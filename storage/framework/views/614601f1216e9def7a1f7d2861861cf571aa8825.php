                        ...
                        <?php if($roles->count() > 0): ?>
                           <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                 ...
                                 <td><?php echo e(GetModuleTitle($value->permissions)); ?></td>
                                 <td>
                                    <ul class="action_btns_wrap a-i-c">
                                       ...
                                       <label class="switch mini-switch" style="display: none;">
                                           <input type="checkbox" class="target_switch" data-attr="<?php echo e(Route('role-active',$value->_id)); ?>" <?php echo e($value->active==1 ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megatanws/public_html/web/resources/views/admin/modules/role/list.blade.php ENDPATH**/ ?>