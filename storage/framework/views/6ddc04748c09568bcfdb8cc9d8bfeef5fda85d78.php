                        ...
                        <?php if($Coupons->count() > 0): ?>
                           <?php $__currentLoopData = $Coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                 ...
                                 <td><?php echo e(ucwords($value->coupon)); ?></td>
                                 <td><?php echo ($value->discount_type == 1) ? $value->discount.'%' : $value->discount; ?></td>
                                 <td><?php echo fnDateFormat($value->expire_date); ?></td>
                                 <td>
                                    <ul class="action_btns_wrap a-i-c">
                                       ...
                                       <label class="switch mini-switch ">
                                          <input type="checkbox" class="target_switch" data-attr="<?php echo e(Route('coupon-active',$value->_id)); ?>" <?php echo e($value->active==1 ? 'checked' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megatanws/public_html/web/resources/views/admin/modules/coupon/list.blade.php ENDPATH**/ ?>